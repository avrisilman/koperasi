                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="td-actions text-right">
                          <a href="<?php echo site_url('pembelian/edit/')."?pengeluaran=".$value->id; ?>"><i class="tim-icons icon-pencil" ></i></a>
                          &nbsp;&nbsp;|&nbsp;&nbsp;
                          <a href="<?php echo site_url('pembelian/delete/')."?pengeluaran=".$value->id; ?>"><i class="tim-icons icon-trash-simple"></i></a>
                        </td>
                      </tr>
                      <?php $no++;}?>
                    </tbody>
