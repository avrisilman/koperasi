                ...
                <div class="row">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                          <label>Jenis Pinjaman</label>
                            <select name="jenis_pinjaman" class="form-control">
                               <option style="color: black;" value="<?php echo $jenis_pinjaman;?>"><?php echo $jenis_pinjaman;?></option>
                       ...
                       <div class="form-group">
                        ...
                        <input type="number" name="jmlpinjaman" class="form-control" placeholder="Masukan Jumlah Pinjaman" value="<?php echo $jmlpinjaman;?>">
                      </div>
                       <div class="form-group">
                        <label>Bunga</label>
                        <input type="text" name="bunga" class="form-control" placeholder="Masukan Bunga" value="<?php echo $bunga;?>">
                      </div>
                       <div class="form-group">
                       <label>Tenor</label>
                          <select name="tenor" class="form-control">
                             <option style="color: black;" value="<?php echo $tenor;?>"><?php echo $tenor;?></option>
